    ...
    public partial class _Default : Page
    {
        ...
        protected void btnAddCustomer_Click(object sender, EventArgs e)
        {
            if (txtFirstName.Text == "" | txtMiddleInitial.Text == "" | txtLastName.Text == "" |
                txtEmail.Text == "" | txtAddress.Text == "" | txtCity.Text == "" |
                txtState.Text == "" | txtZip.Text == "" | txtPhoneExt.Text == "" | txtPhoneNumber.Text == "")
                lblErrorMessage.Text = "Empty Fields";
            else
            {
        ...
        protected void btnSearch_OnClick(object sender, EventArgs e)
        {
            using (SqlConnection sqlCon = new SqlConnection(connectionString))
            {
                String str = "SELECT Customer.FName, Customer.MName, Customer.LName, " +
                             "Customer.CustomerEmail, CustomerAddress.Address, " +
