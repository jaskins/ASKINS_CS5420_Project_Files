<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateOrders.aspx.cs" Inherits="SNS.CreateOrders" %>
        ...
        <table>
            <tr>
                ...
                <td colspan="6" style="width: 291px">
                    <asp:TextBox ID="txtCustomerID" runat="server" Width="173px" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td colspan="6" style="width: 291px">
                    <asp:TextBox ID="txtPhoneNumberSeven" runat="server" Width="173px" ></asp:TextBox>
                </td>
            </tr>
<%--            <tr>--%>
